\section*{Appendix - Building the morphisms $S_G, T_G, S_{m,n}, T_{m,n}$}
%
%
...
In the following, we will explain the process for the function $S_G$, 
...
Now we focus on the morphisms $S_{m,n}, T_{m,n}: X^{f(m,n)} \otimes X^m \to X^n $.
